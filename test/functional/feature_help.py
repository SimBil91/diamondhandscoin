...
"""Verify that starting hubucoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hubucoin with -h for help text")
        ...
        self.log.info("Start hubucoin with -version for version information")
        ...
        self.log.info("Start hubucoind with -fakearg to make sure it does not start")

...
"""Verify that starting diamondhandscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start diamondhandscoin with -h for help text")
        ...
        self.log.info("Start diamondhandscoin with -version for version information")
        ...
        self.log.info("Start diamondhandscoind with -fakearg to make sure it does not start")

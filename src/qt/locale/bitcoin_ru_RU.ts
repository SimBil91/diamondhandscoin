...
<context>
    ...
    <message>
        ...
        <translation>Это ваши DiamondHandsCoin адреса для отправки платежа. Всегда проверяйте сумму и адрес получателя перед отправкой платежа.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши DiamondHandsCoin адреса для получения платежей. Настоятельно рекомендуем использовать новые адреса для получения каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ваш кошелек теперь зашифрован. Помните, что шифрование вашего кошелька не может полностью защитить ваши DiamondHandsCoinы от кражи вредоносным ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Послать средства на DiamondHandsCoin адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения DiamondHandsCoin адресами чтобы подтвердить что это написали именно Вы</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified DiamondHandsCoin addresses</source>
        <translation>Проверяйте сообщения чтобы убедиться что они подписаны конкретными DiamondHandsCoin адресами</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Открыть DiamondHandsCoin: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети DiamondHandsCoin</numerusform><numerusform>%n активных подключения к сети DiamondHandsCoin</numerusform><numerusform>%n активных подключений к сети DiamondHandsCoin</numerusform><numerusform>%n активных подключений к сети DiamondHandsCoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. DiamondHandsCoin больше не может продолжать безопасную работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным адресом DiamondHandsCoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для DiamondHandsCoin-клиента на маршрутизаторе. Работает только если Ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключится к сети DiamondHandsCoin через SOCKS5 прокси.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью DiamondHandsCoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить diamondhandscoin: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'diamondhandscoin://' не верный URI. Используйте 'diamondhandscoin:' вместо этого.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать идентификатор! Это может быть связано с неверным DiamondHandsCoin-адресом или неправильными параметрами идентификатора.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть DiamondHandsCoin.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Предупреждение: Неверный DiamondHandsCoin адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>DiamondHandsCoin-адрес, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Сообщение прикрепленное к diamondhandscoin идентификатору будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть DiamondHandsCoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>DiamondHandsCoin-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать предыдущий использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение DiamondHandsCoin-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>DiamondHandsCoin-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified DiamondHandsCoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным DiamondHandsCoin-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>

DiamondHandsCoin Core version 0.16.3 is now available from:

  <https://download.diamondhandscoin.org/diamondhandscoin-0.16.3/>
...
DiamondHandsCoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of

# Support for Output Descriptors in Hubucoin Core

Since Hubucoin Core v0.17, there is support for Output Descriptors. This is a
...
on Hubucoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Hubucoin Core wallets, a convenience function `combo` is

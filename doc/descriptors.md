# Support for Output Descriptors in DiamondHandsCoin Core

Since DiamondHandsCoin Core v0.17, there is support for Output Descriptors. This is a
...
on DiamondHandsCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing DiamondHandsCoin Core wallets, a convenience function `combo` is

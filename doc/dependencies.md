...
These are the dependencies currently used by DiamondHandsCoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
